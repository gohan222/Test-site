...
module.exports = React.createClass({
  ...
  render: function() {
    ...
    if(this.props.fileType.indexOf('video') >= 0){
      player = React.DOM.video({className:'program-video-control', src:this.props.src, controls:true, autoPlay:false, preload:'metadata'});
      ...
      player = React.DOM.audio({className:'program-player-control', src:this.props.src, controls:true, autoPlay:false, preload:'metadata'});
